                    ...
                    @if ($etudiants->count() > 0)
                        <tbody>
                            ...
                            <tr class="row100 body">
                                <td class="cell80 column1">{{ $etudiant->id }}</td>
                                <td class="cell100 column2">{{ $etudiant->nom }}</td>
                                <td class="cell100 column3">{{ $etudiant->prenom }}</td>
                                <td class="cell100 column4">{{ $etudiant->email }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    @else
